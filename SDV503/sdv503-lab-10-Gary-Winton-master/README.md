<h1 align="center">Welcome to lab 10 👋</h1>
<p>
...
## :page_facing_up: Lab 10 Description

:arrow_right: `Create a function that for the  game "rock, paper, scissors". The function takes the input of two players (rock, paper or scissors), first parameter from first player, second from second player. The function returns the result as following:`
...
Example: 
```javascript
    const result = MyFunction("paper", "rock") 
    console.log(result) // "Player One wins"
``` 
```javascript
   const result = MyFunction("paper", "scissors")
   console.log(result) //[['SDV503'], "Player Two wins"
```
```javascript
   const result = MyFunction("scissors", "scissors")
   console.log(result) // "TIE"
```

:arrow_right: `Create a function that takes an array of numbers and returns an array with duplicate numbers removed and
is sorted from least to greatest value`

Example:
```javascript
   const result = MyFunction([1, 2, 4, 3])
   console.log(result) // [1, 2, 3, 4]
```
```javascript
   const result = MyFunction([1, 4, 4, 4, 4, 4, 3, 2, 1, 2])
   console.log(result) // [1, 2, 3, 4]
```

## :books: Resources 

|[MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript)|[W3schools](https://www.w3schools.com/js/default.asp)|[JavaScript Eloquent](https://eloquentjavascript.net/)|[JS Data Structures & Algorithms](https://github.com/trekhleb/javascript-algorithms)|
|---|---|---|---|
